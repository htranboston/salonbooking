					...
					service_start = service_end;
					 ...
					 (parseInt(duration[0])*60*60 + parseInt(duration[1])*60)*1000;
					    ...
					    count_items += 1;
                                            ...
                                            addServiceToAssistants(service_start, service_end, ' break-down no-border-top');

                                            service_start = service_end + breakDurationMs ;
                                            service_end   = service_start + Math.ceil(durationMs / 2);
                                            addServiceToAssistants(service_start, service_end, ' break-up no-border-top');

                                        } else {
                                            service_end = service_start + durationMs;
                                            addServiceToAssistants(service_start, service_end, ' no-border-top');
                                        }
