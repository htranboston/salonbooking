...
var DayCalendarHolydays = {
    ...
    "clearSelection":function(){
        ...
        $(' .cal-day-hour-part').off('click', DayCalendarHolydays.clearSelection);
    ...
    "createPopUp":function (status,firstEl,lastEl,els, rule){
        ...
        var firstD = firstB.attr('data-event-date'),
            ...
            if(endDay){
                ...
                lastD = today.toLocaleDateString('it-IT',{year:"numeric",day:"2-digit",month:"2-digit"}).split('/').reverse().join('-').replace(/[^0-9\-]/g, '');
            }else{
   ...
   $('.sln-btn[data-calendar-view="day"] button[data-calendar-nav]').on('click', DayCalendarHolydays.clearSelection);
}
