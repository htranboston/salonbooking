...
class SLN_Enum_AvailabilityModeProvider  extends SLN_Enum_AbstractEnum
{
     ...
     * @throws Exception
     */
    public static function getService($key, DateTime $date, SLN_Helper_Availability $availability, SLN_Wrapper_Booking $booking = null)
    {
        $name = self::getServiceName($key);

        return new $name($date, $availability, $booking);
    }
