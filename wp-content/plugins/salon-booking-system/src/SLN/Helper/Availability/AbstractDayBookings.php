...
abstract class SLN_Helper_Availability_AbstractDayBookings
{
    ...
    public function __construct(DateTime $date, SLN_Helper_Availability $availability, SLN_Wrapper_Booking $booking = null)
    {
        $holidays = SLN_Plugin::getInstance()->getSettings()->getHolidayItems();

        $this->minutesIntervals = SLN_Func::getDateMinutesIntervals($date, $availability->getItemsWithoutServiceOffset());
        $this->date = $date;
