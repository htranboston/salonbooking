...
class SLN_Helper_Availability
{
	...
	if($duration instanceof DateTime && $times && $ret = $this->validateAttendantOnTime($attendant, $times[0], true, $duration)) {
	    return $ret;
	}
    ...
    private function validateAttendantOnTime(SLN_Wrapper_AttendantInterface $attendant, SLN_DateTime $time, $checkDuration = false, DateTime $duration = null)
    {
        ...
        if($checkDuration && $duration) {
            if ($attendant->isNotAvailableOnDateDuration($time, $duration)) {
