...
*/
	...
	$(".sln-admin-banner--trigger, .sln-admin-banner--close").on('click',
	    function(event) {
	...
	allowClear: true,
        ...
        ajax: {
            url: salon.ajax_url + '&action=salon&method=SearchAssistantStaffMember&security=' + salon.ajax_nonce,
            dataType: 'json',
            delay: 250,
	...
	var user_id = typeof selected_option !== 'undefined' ? selected_option['staff_member_id'] || $(selected_option.element).data('staff-member-id'): '';
