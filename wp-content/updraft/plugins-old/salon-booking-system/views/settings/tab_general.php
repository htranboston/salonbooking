...
<div id="sln-email_new_booking" class="sln-box sln-box--main">
    <div class="row">
        <div class="col-xs-12">
            <h2 class="sln-box-title"><?php _e('New booking email notification to customer', 'salon-booking-system')?></h2>
        </div>
        <div class="col-xs-12">
